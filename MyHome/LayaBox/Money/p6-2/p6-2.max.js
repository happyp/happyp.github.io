...
var Main=(function(_super){
	...
	__proto.loadAsset=function(){
		...
		arr.push("sounds/true1.mp3");
		arr.push("sounds/true2.mp3");
		arr.push("sounds/false1.mp3");
		arr.push("sounds/false2.mp3");
...
var Screen=(function(_super){
	...
	__proto.onImagePlay=function(e){
		...
		switch(e.currentTarget.name){
			case "img_btn1":
				if (this.stpe==1){
					this.animationPage.setAni("page1/未命名-1",1200,1080);
					this.animationPage.total=36;
					SoundManager.playMusic("sounds/page1.mp3",1);
				}
				else{
					this.animationPage.setAni("page3/未命名-1",1200,1080);
					this.animationPage.total=28;
					SoundManager.playMusic("sounds/page3.mp3",1);
				}
				break ;
			case "img_btn2":
				if (this.stpe==1){
					this.animationPage.setAni("page2/未命名-1",1200,1080);
					this.animationPage.total=36;
					SoundManager.playMusic("sounds/page2.mp3",1);
				}
				else{
					this.animationPage.setAni("page4/未命名-1",1200,1080);
					this.animationPage.total=28;
	...
	__proto.onResetPoint=function(e){
		...
		for (i=1;i <=2;i++){
			if (Maths.dis(this["xiao_clip"+i].x,this["xiao_clip"+i].y,this.xiao_img.x,this.xiao_img.y)< this.xiao_img.width){
				if (this.stpe==1){
					if (i==1){
						SoundManager.playMusic("sounds/true1.mp3",1,new Handler(this,this.onStpeOver));;
						this.ani_1.visible=true;
						this.xiao_img.visible=false;
						this.pused();
					}
					else if(i==2){
						SoundManager.playMusic("sounds/false1.mp3",1);
					}
				}
				if (this.stpe==2){
					if (i==1){
						SoundManager.playMusic("sounds/false2.mp3",1);
					}
					else if(i==2){
						SoundManager.playMusic("sounds/true1.mp3",1);
						this.ani_2.visible=true;
						this.xiao_img.visible=false;
					}
				}
				i=7
	...
	/**暂时停止交互*/
	__proto.pused=function(){
		this.img_btn1.mouseEnabled=false;
		this.img_btn2.mouseEnabled=false;
		this.question_btn.mouseEnabled=false;
	}

	/**第一步结束*/
	__proto.onStpeOver=function(){
		this.stpe=2;
		this.clip_img1.index=1;
		this.clip_img2.index=1;
		this.ani_1.visible=false;
		this.ani_2.visible=false;
		this.xiao_img.visible=true;
		this.img_btn1.mouseEnabled=true;
		this.img_btn2.mouseEnabled=true;
