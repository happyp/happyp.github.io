...
var Main=(function(_super){
	...
	__proto.loadAsset=function(){
		...
		arr.push("image/clip_1.png");
		arr.push("image/clip_2.png");
		arr.push("image/clip_3.png");
		arr.push("image/clip_4.png");
		...
		for (i=1;i <=15;i++){
			if (i < 10){
				...
				arr.push("page4/未命名-100"+i+".png");
			}
		}
		for (i=1;i <=30;i++){
			if (i < 10){
				arr.push("page5/未命名-1000"+i+".png");
			}
			else{
...
var ScreenUI=(function(_super){
	...
	__static(ScreenUI,
	['uiView',function(){return this.uiView={"type":"View","props":{"width":1920,"height":1080},"child":[{"type":"Image","props":{"skin":"image/bg_img.png"}},{"type":"Image","props":{"y":9,"x":162,"var":"tip_img","skin":"image/tip.png"}},{"type":"Button","props":{"y":53,"x":1596,"var":"question_btn","stateNum":1,"skin":"image/btn_question.png"}},{"type":"Clip","props":{"y":434,"x":249,"var":"clip1","skin":"image/clip_1.png","name":"clip1","index":0,"clipX":2,"anchorY":0.5,"anchorX":0.5}},{"type":"Clip","props":{"y":434,"x":605,"var":"clip2","skin":"image/clip_2.png","name":"clip2","clipX":2,"anchorY":0.5,"anchorX":0.5}},{"type":"Clip","props":{"y":434,"x":960,"var":"clip3","skin":"image/clip_3.png","name":"clip3","clipX":2,"anchorY":0.5,"anchorX":0.5}},{"type":"Clip","props":{"y":434,"x":1316,"var":"clip4","skin":"image/clip_4.png","name":"clip4","clipX":2,"anchorY":0.5,"anchorX":0.5}},{"type":"Clip","props":{"y":434,"x":1671,"var":"clip5","skin":"image/clip_5.png","name":"clip5","clipX":2,"anchorY":0.5,"anchorX":0.5}},{"type":"Image","props":{"y":843,"x":1328,"var":"img_btn1","skin":"image/img_1.png","name":"img_btn1","anchorY":0.5,"anchorX":0.5}},{"type":"Image","props":{"y":843,"x":761,"var":"img_btn2","skin":"image/img_2.png","name":"img_btn2","anchorY":0.5,"anchorX":0.5}},{"type":"Image","props":{"y":843,"x":1139,"var":"img_btn3","skin":"image/img_3.png","name":"img_btn3","anchorY":0.5,"anchorX":0.5}},{"type":"Image","props":{"y":843,"x":950,"var":"img_btn4","skin":"image/img_4.png","name":"img_btn4","anchorY":0.5,"anchorX":0.5}},{"type":"Image","props":{"y":843,"x":572,"var":"img_btn5","skin":"image/img_5.png","name":"img_btn5","anchorY":0.5,"anchorX":0.5}},{"type":"Button","props":{"y":277,"x":347,"var":"play_btn1","skin":"image/btn_play.png","name":"play_btn1"}},{"type":"Button","props":{"y":277,"x":703,"var":"play_btn2","skin":"image/btn_play.png","name":"play_btn2"}},{"type":"Button","props":{"y":277,"x":1060,"var":"play_btn3","skin":"image/btn_play.png","name":"play_btn3"}},{"type":"Button","props":{"y":277,"x":1412,"var":"play_btn4","skin":"image/btn_play.png","name":"play_btn4"}},{"type":"Button","props":{"y":277,"x":1771,"var":"play_btn5","skin":"image/btn_play.png"}}]};}
	]);
	return ScreenUI;
})(View)
...
var Screen=(function(_super){
	function Screen(){
		...
		for (var i=1;i <=5;i++){
			this["img_btn"+i].on("mousedown",this,this.onDragPerson);
			this.pointArr.push(new Point(this["img_btn"+i].x,this["img_btn"+i].y));
			this["play_btn"+i].on("mousedown",this,this.onImagePlay);
			this["play_btn"+i].visible=false;
		}
		this.animationPage=new AnimationPage(false,"#9DC7ED");
	...
	__proto.onImagePlay=function(e){
		...
		switch(e.currentTarget.name){
			case "play_btn1":
				this.animationPage.setAni("page1/未命名-1",1080,1080);
				this.animationPage.total=15;
				SoundManager.playMusic("sounds/page1.mp3",1);
				break ;
			case "play_btn2":
				this.animationPage.setAni("page2/未命名-1",1080,1080);
				this.animationPage.total=15;
				SoundManager.playMusic("sounds/page2.mp3",1);
				break ;
			case "play_btn3":
				this.animationPage.setAni("page3/未命名-1",1080,1080);
				this.animationPage.total=62;
				SoundManager.playMusic("sounds/page3.mp3",1);
				break ;
			case "play_btn4":
				this.animationPage.setAni("page4/未命名-1",1080,1080);
				this.animationPage.total=15;
				SoundManager.playMusic("sounds/page4.mp3",1);
				break ;
			case "play_btn5":
				this.animationPage.setAni("page5/未命名-1",1080,1080);
				this.animationPage.total=30;
				SoundManager.playMusic("sounds/page5.mp3",1);
				break ;
			}
	}

	__proto.onDragPerson=function(e){
		var str=e.currentTarget.name;
		this.typeNum=str.substr(7,1);
		console.log(this.typeNum)
		e.currentTarget.startDrag(this.dragRect,false,0);
		e.currentTarget.on("mouseup",this,this.onResetPoint);
	}

	__proto.onResetPoint=function(e){
		this["img_btn"+this.typeNum].off("mouseup",this,this.onResetPoint);
		if(Math.abs(this["img_btn"+this.typeNum].x-this["clip"+this.typeNum].x)< 200 && Math.abs(this["img_btn"+this.typeNum].y-this["clip"+this.typeNum].y)< 360){
			console.log("good");
			this["img_btn"+this.typeNum].stopDrag();
			this["img_btn"+this.typeNum].visible=false;
			this["clip"+this.typeNum].index=1;
			this.animationPage.visible=true;
			this["play_btn"+this.typeNum].visible=true;
			switch(this.typeNum){
				case "1":
					this.animationPage.setAni("page1/未命名-1",1080,1080);
					this.animationPage.total=15;
			...
			this["img_btn"+this.typeNum].x=this.pointArr[this.typeNum-1].x;
			this["img_btn"+this.typeNum].y=this.pointArr[this.typeNum-1].y;
