...
var MainUI=(function(_super){
	...
	__proto.onImagePlay=function(e){
		...
		switch(e.currentTarget.name){
			case "img_btn1":
				this.animationPage.setAni("page1/1",1400,1030);
				this.animationPage.total=36;
				SoundManager.playMusic("sounds/page1.mp3",1);
				break ;
			case "img_btn2":
				this.animationPage.setAni("page2/1",1400,1030);
				this.animationPage.total=30;
				SoundManager.playMusic("sounds/page2.mp3",1);
				break ;
			case "img_btn3":
				this.animationPage.setAni("page3/1",1400,1030);
				this.animationPage.total=50;
