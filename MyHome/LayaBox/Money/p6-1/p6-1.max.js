...
var Main=(function(_super){
	...
	__proto.loadAsset=function(){
		...
		arr.push("image/train.png");
		arr.push("res/atlas/image.atlas");
		for (i=1;i <=36;i++){
			if (i < 10){
				arr.push("page1/1000"+i+".png");
			}
			else{
				arr.push("page1/100"+i+".png");
			}
		}
		for (i=1;i <=30;i++){
			if (i < 10){
				arr.push("page2/1000"+i+".png");
			}
			else{
				arr.push("page2/100"+i+".png");
			}
		}
		for (i=1;i <=50;i++){
			if (i < 10){
				arr.push("page3/1000"+i+".png");
			}
			else{
				arr.push("page3/100"+i+".png");
			}
		}
		arr.push("sounds/lose.mp3");
		arr.push("sounds/page1.mp3");
		arr.push("sounds/page2.mp3");
		arr.push("sounds/page3.mp3");
		arr.push("sounds/win.mp3");
		arr.push("sounds/tip.mp3");
		arr.push("sounds/train.wav");
...
var MainUIUI=(function(_super){
	function MainUIUI(){
		...
		this.train_img=null;
		this.clipTrue_2=null;
		this.clipTrue_3=null;
		this.clipTrue_1=null;
		this.clip_1=null;
		this.clip_2=null;
		this.clip_3=null;
		this.drag_1=null;
...
var Page1UI=(function(_super){
	...
	__static(Page1UI,
	['uiView',function(){return this.uiView={"type":"View","props":{"width":1920,"height":1080},"child":[{"type":"Label","props":{"width":1920,"mouseEnabled":true,"height":1080,"bgColor":"#d7f6f6"}},{"type":"Image","props":{"y":25,"x":260,"var":"img","skin":"page1/10001.png"}}]};}
	]);
	return Page1UI;
})(View)
...
var MainUI=(function(_super){
	function MainUI(){
		...
		var i=0;
		for (i=1;i <=3;i++){
			this["drag_"+i].on("mousedown",this,this.onDrag);
			this.pointArr.push(new Point(this["drag_"+i].x,this["drag_"+i].y));
	...
	__proto.onResetPoint=function(){
		...
		if (Maths.dis(this["drag_"+this.typeNum].x,this["drag_"+this.typeNum].y,this["clip_"+this.typeNum].localToGlobal(new Point(0,0)).x,this["clip_"+this.typeNum].localToGlobal(new Point(0,0)).y)< (this["clip_"+this.typeNum].width+this["drag_"+this.typeNum].width)/ 2){
			console.log("ok");
			this["drag_"+this.typeNum].stopDrag();
			this["drag_"+this.typeNum].visible=false;
			this["clip_"+this.typeNum].index=1;
			this["clipTrue_"+this.typeNum].index=1;
			SoundManager.playMusic("sounds/win.mp3",1);
			this.successNum++;
			if (this.successNum==3){
				Tween.to(this.train_img,{x:-2000},2300);
				SoundManager.playMusic("sounds/train.wav",1);
			}
		}
		else{
			this["drag_"+this.typeNum].x=this.pointArr[this.typeNum-1].x;
			this["drag_"+this.typeNum].y=this.pointArr[this.typeNum-1].y;
...
var Page1=(function(_super){
	...
	__proto.init=function(){
		this.img.skin="page"+this.pageType+"/1000"+1+".png"
	...
	__proto.onAnimation=function(){
		this.index++;
		if (this.index < 10){
			this.img.skin="page"+this.pageType+"/1000"+this.index+".png"
		}
		else{
			this.img.skin="page"+this.pageType+"/100"+this.index+".png"
		}
