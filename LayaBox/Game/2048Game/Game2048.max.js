...
var Main=(function(){
	function Main(){
		...
		game.x=(Laya.stage.width-400)*0.5;
		game.y=(Laya.stage.height-400)*0.5;
	}
...
var GameMain=(function(_super){
	...
	*/
	...
	__proto.addNumData=function(){
		...
		var stpe=GameMain.randomInt(1,1);
...
var HTMLImage=(function(_super){
	...
	*/
	...
	Laya.__init([LoaderManager,EventDispatcher,Browser,Render,Timer,LocalStorage]);
	new Main();
